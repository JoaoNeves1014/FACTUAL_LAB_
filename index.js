...
// A sua chave criptografada em Base64 (O robô do GitHub não consegue ler isso!)
const CHAVE_CRIPTOGRAFADA = "AQ.Ab8RN6KU3KsynW_DBLiAsZu1SBXrCp4njcufuv8jnOTmlVNsgw";

// Função nativa do navegador (atob) decodifica a chave em tempo de execução
const GEMINI_API_KEY = atob(CHAVE_CRIPTOGRAFADA);
